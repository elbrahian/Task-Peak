...
public final class BusinessTaskPeakException extends TaskPeakException {

	private static final long serialVersionUID = 1L;
	private static final Lugar lugar = Lugar.BUSINESS;

	public BusinessTaskPeakException(final String mensajeUsuario) {
		super(mensajeUsuario, lugar);
	}

	public BusinessTaskPeakException(final String mensajeTecnico, final String mensajeUsuario) {
