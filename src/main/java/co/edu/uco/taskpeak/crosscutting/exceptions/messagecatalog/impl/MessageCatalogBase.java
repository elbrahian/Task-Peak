package co.edu.uco.taskpeak.crosscutting.exceptions.messagecatalog.impl;

import java.util.HashMap;
import java.util.Map;

import co.edu.uco.taskpeak.crosscutting.exceptions.custom.CrosscuttingTaskPeakException;
import co.edu.uco.taskpeak.crosscutting.exceptions.messagecatalog.MessageCatalog;
...
public final class MessageCatalogBase implements MessageCatalog {
	...
	public final void inicializar() {
		...
		mensajes.put(CodigoMensaje.M00009.getIdentificador(), new Mensaje(CodigoMensaje.M00009,
				"Se ha intento realizar el ciere de una conexion SQL que ya estaba cerrada.."));
	...
	public final Mensaje obtenerMensaje(final CodigoMensaje codigo, final String... parametros) {
		...
		if (ObjectHelper.getObjectHelper().isNull(codigo)) {
			...
			throw new CrosscuttingTaskPeakException(mensajeTecnico, mensajeUsuario);
		}
